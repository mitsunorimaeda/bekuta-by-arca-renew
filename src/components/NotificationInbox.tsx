...
export function NotificationInbox({ userId }: NotificationInboxProps) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {/* ドロップダウンパネル */}
      {open && (
        <div className="absolute right-0 top-12 w-80 max-h-96 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
          {/* ヘッダー */}
