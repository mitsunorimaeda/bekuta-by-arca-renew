...
export function PerformanceRecordForm({
  ...
  const canInputData = userRole === 'staff' || userRole === 'admin' || userRole === 'organization_admin';

  if (!canInputData) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border dark:border-gray-700 transition-colors">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              パフォーマンス計測データの入力は、コーチ・組織管理者のみが行えます。
              選手の皆さんは、コーチが入力したデータを閲覧・分析できます。
            </p>
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
              ...
              <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                <li>• 測定条件の統一：正確で公平なデータ収集</li>
                <li>• データの信頼性：専門的な視点での測定と記録</li>
                <li>• チーム全体の管理：一貫した評価基準の維持</li>
              </ul>
            </div>
          </div>
        </div>
