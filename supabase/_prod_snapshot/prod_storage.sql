...
CREATE POLICY "allow authenticated upload nutrition images" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'nutrition-images'::"text"));



CREATE POLICY "allow public read nutrition images" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'nutrition-images'::"text"));
...
CREATE POLICY "nutrition_images_delete_own" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'nutrition-images'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "nutrition_images_insert_own" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'nutrition-images'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "nutrition_images_read_own" ON "storage"."objects" FOR SELECT TO "authenticated" USING ((("bucket_id" = 'nutrition-images'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));
